...
- (void)downloadToUser:(void (^)(uint8_t *data, NSUInteger length))contentReceivedBlock {
    self.responseContentHandler = [[BBHTTPReturner alloc] initWithBlock:contentReceivedBlock];
}
