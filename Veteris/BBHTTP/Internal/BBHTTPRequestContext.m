...
- (BOOL)finishCurrentResponse
{
    ...
    BOOL isRedirect = [self isCurrentResponse30XRedirect];
    ...
    [_currentResponse finishWithContent:parsedContent size:_downloadedBytes
                             successful:(_error == nil && !isRedirect)];
...
- (BOOL)isCurrentResponse30XRedirect
{
    ...
    return _currentResponse.code == 301 || _currentResponse.code == 302 ||
           _currentResponse.code == 303 || _currentResponse.code == 307 ||
           _currentResponse.code == 308;
}
