...
{
    self = [self initWithTargetFile:pathToFile];
    if (self != nil) {
                      ...
                      error:(NSError**)error
{
    ...
    BOOL append = (_resumeOffset > 0 && statusCode == 206);
    _stream = [NSOutputStream outputStreamToFileAtPath:_pathToFile append:append];
    [_stream open];
    _needsCleanup = YES;
