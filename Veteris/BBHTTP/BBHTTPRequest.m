...
NSString* NSStringFromBBTransferSpeed(BBTransferSpeed transferSpeed)
{
    return [NSString stringWithFormat:@"%lu/s for %lu seconds",
            (unsigned long)transferSpeed.bytesPerSecond, (unsigned long)transferSpeed.duration];
}
...
{
    NSString* headerValue = [_headers valueForKey:header];
