...
- (id)init {
    ...
    if (self) {
        ...
        //DebugLog(@"preferences_location: %@", preferences_location);
        if (_dict == nil) {
...
- (void)setupConfig {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/var/lib/clutch/"]) {
        [[NSFileManager defaultManager] createDirectoryAtPath:@"/var/lib/clutch" withIntermediateDirectories:YES attributes:nil error:&error];
    }
